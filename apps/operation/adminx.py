...
from .models import UserAsk, UserFavorite, UserCourse, UserMessage,CourseComents
...
class CourseComentsgAdmin(object):
...
xadmin.site.register(CourseComents, CourseComentsgAdmin)
