# -*- coding: utf-8 -*-
# Generated by Django 1.9.8 on 2017-12-28 05:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.CharField(choices=[('prem', '\u521d\u7ea7'), ('mid', '\u4e2d\u7ea7'), ('high', '\u9ad8\u7ea7')], max_length=5)),
                ...
                ('image', models.ImageField(default='image/default.png', upload_to='course/%Y/%m')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='\u6dfb\u52a0\u65f6\u95f4')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='courses.Course', verbose_name='\u8bfe\u7a0b1')),
            ],
            options={
                'verbose_name': '\u8d44\u6e90',
